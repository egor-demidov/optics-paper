...
\begin{figure}[htp]
    ...
    legend cell align={left}
        ...
        \addplot [only marks,tab_blue,mark=otimes*,mark options={scale=0.5}] table {recharged_coated_nigrosin_fresh.txt} node [above,pos=0.33] {$1\rightarrow 2$} node [above,pos=0.5] {$q\rightarrow q$} node [above,pos=0.7] {$2\rightarrow 1$};
        \addplot [only marks,tab_orange,mark=square*,mark options={scale=0.5}] table {recharged_coated_nigrosin_coated.txt};
