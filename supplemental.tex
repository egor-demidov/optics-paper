...
\label{s:sec:tabulated-mobility}

\begin{table}[!htp]
\centering
\begin{tabular}{c c c c c c c}
    & Soot & CB\textsubscript{cmp} & CB\textsubscript{agg} & Nigrosin & & PSL\\
    $D,\rm\ nm$ & $m,\rm\ fg$ & $m,\rm\ fg$ & $m,\rm\ fg$ & $m,\rm\ fg$ & $D,\rm\ nm$ & $m,\rm\ fg$\\
    150 & x & x & 1.39 & 2.54 & 152 & x\\
    180 & x & x & 2.27 & 4.34 & 240 & x\\
    210 & x & x & 3.43 & 6.84 & 345 & x\\
    240 & x & x & 4.91 & 10.1\\
    270 & x & x & 6.73 & 14.4\\
    300 & x & x & 8.93 & 19.6\\
    330 & x & x & 11.5 & 25.9\\
