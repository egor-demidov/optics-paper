	...
	\resizebox{\textwidth}{!}{
		\begin{tikzpicture}
			\begin{axis}[
				...
				ylabel=$N$	
                    ...
                    \addplot+[smooth,no markers] table [x=X_150,y=Y_150,col sep=comma]{tdma_recharged_recharged_soot.csv};
				\addplot+[smooth,no markers,dashed,style={ultra thick}] table [x=X_240,y=Y_240,col sep=comma] {tdma_recharged_recharged_soot.csv};
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot+[smooth,no markers] table [x=X_150,y=Y_150,col sep=comma] {tdma_recharged_recharged_nigrosin.csv};
	...
	\resizebox{\textwidth}{!}{
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot+[smooth,no markers] table [x=X_150,y=Y_150,col sep=comma] {tdma_recharged_recharged_cb_cmp.csv};
				\addplot+[smooth,no markers,dashed,style={ultra thick}] table [x=X_240,y=Y_240,col sep=comma] {tdma_recharged_recharged_cb_cmp.csv};
				\addlegendentry{150 nm}
				\addlegendentry{240 nm}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot+[smooth,no markers] table [x=X_150,y=Y_150,col sep=comma] {tdma_recharged_recharged_cb_agg.csv};
				\addplot+[smooth,no markers,dashed,style={ultra thick}] table [x=X_240,y=Y_240,col sep=comma] {tdma_recharged_recharged_cb_agg.csv};
				\addlegendentry{150 nm}
				\addlegendentry{240 nm}
...
\begin{figure}[htp]
    ...
    ymax=4.5e-2
        ...
        \addplot [only marks,color=tab_blue,mark=otimes*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_abs,y error=C_abs_err_res] {absolute_experimental_soot_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_blue] table [col sep=tab,y=C_abs_mie] {absolute_mie_soot.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_blue] table [col sep=tab,y=C_abs_corr] {absolute_mie_soot.txt};
        \addlegendentry{Mie(++)}
        \addplot [ultra thick,dotted,no markers,color=tab_blue] table [col sep=tab,y=C_abs_rdg] {absolute_mie_soot.txt};
    ...
    ymax=4.5e-2
        ...
        \addplot [only marks,color=tab_orange,mark=square*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_abs,y error=C_abs_err_res] {absolute_experimental_nigrosin.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_orange] table [col sep=tab,y=C_abs_mie] {absolute_mie_nigrosin.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_orange] table [col sep=tab,y=C_abs_corr] {absolute_mie_nigrosin.txt};
        \addlegendentry{Mie(++)}
    ...
    ymax=7.5e-2
        ...
        \addplot [only marks,color=tab_grey,mark=triangle*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_abs,y error=C_abs_err_res] {absolute_experimental_cb_cmp_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_grey] table [col sep=tab,y=C_abs_mie] {absolute_mie_cb_cmp.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_grey] table [col sep=tab,y=C_abs_corr] {absolute_mie_cb_cmp.txt};
        \addlegendentry{Mie(++)}
        \addplot [ultra thick,dotted,no markers,color=tab_grey] table [col sep=tab,y=C_abs_rdg] {absolute_mie_cb_cmp.txt};
        \addlegendentry{RDG/Mie}
    ...
    ymax=6.5e-2
        ...
        \addplot [only marks,color=tab_red,mark=diamond*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_abs,y error=C_abs_err_res] {absolute_experimental_cb_agg_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_red] table [col sep=tab,y=C_abs_mie] {absolute_mie_cb_agg.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_red] table [col sep=tab,y=C_abs_corr] {absolute_mie_cb_agg.txt};
        \addlegendentry{Mie(++)}
        \addplot [ultra thick,dotted,no markers,color=tab_red] table [col sep=tab,y=C_abs_rdg] {absolute_mie_cb_agg.txt};
        \addlegendentry{RDG/Mie}
...
\begin{figure}[htp]
    ...
    ymax=6.5e-2
        ...
        \addplot [only marks,color=tab_blue,mark=otimes*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_sca,y error=C_sca_err_res] {absolute_experimental_soot_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_blue] table [col sep=tab,y=C_sca_mie] {absolute_mie_soot.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_blue] table [col sep=tab,y=C_sca_corr] {absolute_mie_soot.txt};
        \addlegendentry{Mie(++)}
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(a)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{Soot, D\textsubscript{ve} 137 nm}};
    \end{axis}
    ...
    ymax=6.5e-2
        ...
        \addplot [only marks,color=tab_orange,mark=square*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_sca,y error=C_sca_err_res] {absolute_experimental_nigrosin.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_orange] table [col sep=tab,y=C_sca_mie] {absolute_mie_nigrosin.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_orange] table [col sep=tab,y=C_sca_corr] {absolute_mie_nigrosin.txt};
        \addlegendentry{Mie(++)}
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(b)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{Nigrosin, D\textsubscript{ve} 150 nm}};
    \end{axis}
    ...
    ymax=3.5e-2
        ...
        \addplot [only marks,color=tab_grey,mark=triangle*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_sca,y error=C_sca_err_res] {absolute_experimental_cb_cmp_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_grey] table [col sep=tab,y=C_sca_mie] {absolute_mie_cb_cmp.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_grey] table [col sep=tab,y=C_sca_corr] {absolute_mie_cb_cmp.txt};
        \addlegendentry{Mie(++)}
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(c)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{CB\textsubscript{cmp}, D\textsubscript{ve} 111 nm}};
    \end{axis}
    ...
    ymax=6.5e-2
        ...
        \addplot [only marks,color=tab_red,mark=diamond*,error bars/.cd, y dir=both, y explicit] table [col sep=tab,y=C_sca,y error=C_sca_err_res] {absolute_experimental_cb_agg_coated.txt};
        \addlegendentry{Experimental}
        \addplot [no markers,color=tab_red] table [col sep=tab,y=C_sca_mie] {absolute_mie_cb_agg.txt};
        \addlegendentry{Mie(+)}
        \addplot [ultra thick,dashed,no markers,color=tab_red] table [col sep=tab,y=C_sca_corr] {absolute_mie_cb_agg.txt};
        \addlegendentry{Mie(++)}
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(d)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{CB\textsubscript{agg}, D\textsubscript{ve} 170 nm}};
    \end{axis}
