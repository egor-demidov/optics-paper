...
\begin{figure}[htp]
    ...
    ymax=4.5e-2
        ...
        \addplot [only marks,color=tab_blue,mark=otimes*] table [col sep=tab,y=C_abs] {plots/absolute_experimental/soot_coated.txt};
