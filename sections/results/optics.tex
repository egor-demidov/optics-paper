...
Prior to discussing the results, we need to understand the uncertainties associated with each type of measurement. We measure the change in optical properties of aerosols in response to coating and compare experimental results with calculations. Both depend on optical, mass, and size measurements and their respective uncertainties. Also, since the experiments described in this study take hours, variability in bare aerosol throughout the day can introduce additional uncertainty. In this section, we discuss uncertainty contributions from various factors and what was done to minimize them.
...
\begin{figure}[htp]
    ...
    legend cell align={left}
        ...
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(a)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{Soot, 240 nm}};
    \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
    \begin{axis}[
    ...
    legend cell align={left}
        ...
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(b)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{Nigrosin, 150 nm}};
    \end{axis}
    \end{tikzpicture}}
    \resizebox{\columnwidth}{!}{\begin{tikzpicture}
    \begin{axis}[
    ...
    legend cell align={left}
        ...
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(c)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{CB\textsubscript{cmp}, 150 nm}};
    \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
    \begin{axis}[
    ...
    legend cell align={left}
        ...
        \node[anchor=north east] at (rel axis cs:1,1) {\textbf{(d)}};
        \node[anchor=south east] at (rel axis cs:1,0) {\textbf{CB\textsubscript{agg}, 240 nm}};
    \end{axis}
    \end{tikzpicture}}
